...
class FoodSearchProblem:
    ...
    def __init__(self, startingGameState):
        ...
        self.startingFoodList = startingGameState.getFood().asList()
        for i in xrange(len(self.startingFoodList)):
            for j in xrange(i+1, len(self.startingFoodList)):
                u = self.startingFoodList[i]
                v = self.startingFoodList[j]
                dist = mazeDistance(u, v, startingGameState) 
                self.heuristicInfo[(u, v)] = self.heuristicInfo[(v, u)] = dist
